...
// -- Identity Domain --
registerRoute("POST",   "/api/v1/auth/register",            "identity:auth",       "create");
registerRoute("POST",   "/api/v1/auth/verify-email",        "identity:auth",       "verify");
registerRoute("POST",   "/api/v1/auth/login",               "identity:auth",       "login");
registerRoute("POST",   "/api/v1/auth/refresh",             "identity:auth",       "refresh");
registerRoute("POST",   "/api/v1/auth/logout",              "identity:auth",       "revoke");
registerRoute("POST",   "/api/v1/auth/forgot-password",     "identity:auth",       "forgot_password");
registerRoute("POST",   "/api/v1/auth/reset-password",      "identity:auth",       "reset_password");
registerRoute("GET",    "/api/v1/users/me",                 "identity:users",      "read");
registerRoute("PATCH",  "/api/v1/users/me",                 "identity:users",      "update");
registerRoute("GET",    "/api/v1/users",                    "identity:users",      "read");
registerRoute("POST",   "/api/v1/users",                    "identity:users",      "create");
registerRoute("GET",    "/api/v1/users/:id",                "identity:users",      "read",    "id");
registerRoute("PATCH",  "/api/v1/users/:id",                "identity:users",      "update",  "id");
registerRoute("DELETE", "/api/v1/users/:id",                "identity:users",      "delete",  "id");
registerRoute("PATCH",  "/api/v1/users/:id/role",           "identity:roles",      "update");
registerRoute("POST",   "/api/v1/users/:id/disable",        "identity:users",      "update",  "id");
registerRoute("POST",   "/api/v1/users/:id/enable",         "identity:users",      "update",  "id");

// -- Customer Domain --
registerRoute("POST",   "/api/v1/customers",                "customer:customers",  "create");
registerRoute("GET",    "/api/v1/customers",                "customer:customers",  "read");
registerRoute("GET",    "/api/v1/customers/:id",            "customer:customers",  "read",    "id");
registerRoute("PATCH",  "/api/v1/customers/:id",            "customer:customers",  "update",  "id");
registerRoute("DELETE", "/api/v1/customers/:id",            "customer:customers",  "delete",  "id");
registerRoute("PATCH",  "/api/v1/customers/:id/tags",       "customer:customer_tags", "update");
registerRoute("GET",    "/api/v1/customers/tags",           "customer:customer_tags", "read");
registerRoute("GET",    "/api/v1/customers/:id/orders",     "customer:customers",  "read",    "id");
registerRoute("GET",    "/api/v1/customers/:id/communications", "customer:communication_logs", "read");
registerRoute("POST",   "/api/v1/customers/:id/communications", "customer:communication_logs", "create");
registerRoute("POST",   "/api/v1/customers/import",         "customer:customer_import", "create");
registerRoute("POST",   "/api/v1/customers/export",         "customer:customer_export", "create");
registerRoute("POST",   "/api/v1/customers/merge",          "customer:customer_merge",  "create");

// -- Service Domain --
registerRoute("GET",    "/api/v1/services",                 "service:services",    "read");
registerRoute("POST",   "/api/v1/services",                 "service:services",    "create");
registerRoute("GET",    "/api/v1/services/:id",             "service:services",    "read",    "id");
registerRoute("PATCH",  "/api/v1/services/:id",             "service:services",    "update",  "id");
registerRoute("DELETE", "/api/v1/services/:id",             "service:services",    "delete",  "id");
registerRoute("GET",    "/api/v1/services/slug/:slug",      "service:services",    "read");
registerRoute("GET",    "/api/v1/services/categories",      "service:service_categories", "read");
registerRoute("POST",   "/api/v1/orders",                   "service:service_orders", "create");
registerRoute("GET",    "/api/v1/orders",                   "service:service_orders", "read");
registerRoute("GET",    "/api/v1/orders/:id",               "service:service_orders", "read",   "id");
registerRoute("PATCH",  "/api/v1/orders/:id/status",        "service:service_orders", "update", "id");
registerRoute("POST",   "/api/v1/orders/:id/documents",     "service:order_documents", "create", "id");
registerRoute("POST",   "/api/v1/orders/:id/assign",        "service:order_assignment", "create");
registerRoute("POST",   "/api/v1/orders/:id/rate",          "service:order_ratings", "create", "id");
registerRoute("GET",    "/api/v1/orders/:id/timeline",      "service:service_orders", "read",   "id");

// -- Commerce Domain --
registerRoute("GET",    "/api/v1/products",                 "commerce:products",   "read");
registerRoute("POST",   "/api/v1/products",                 "commerce:products",   "create");
registerRoute("GET",    "/api/v1/products/:id",             "commerce:products",   "read",    "id");
registerRoute("PATCH",  "/api/v1/products/:id",             "commerce:products",   "update",  "id");
registerRoute("DELETE", "/api/v1/products/:id",             "commerce:products",   "delete",  "id");
registerRoute("GET",    "/api/v1/products/slug/:slug",      "commerce:products",   "read");
registerRoute("GET",    "/api/v1/categories",               "commerce:product_categories", "read");
registerRoute("POST",   "/api/v1/categories",               "commerce:product_categories", "create");
registerRoute("PATCH",  "/api/v1/categories/:id",           "commerce:product_categories", "update", "id");
registerRoute("DELETE", "/api/v1/categories/:id",           "commerce:product_categories", "delete", "id");
registerRoute("GET",    "/api/v1/cart",                     "commerce:carts",      "read");
registerRoute("POST",   "/api/v1/cart/items",               "commerce:carts",      "create");
registerRoute("PATCH",  "/api/v1/cart/items/:cartItemId",   "commerce:carts",      "update");
registerRoute("DELETE", "/api/v1/cart/items/:cartItemId",   "commerce:carts",      "delete");
registerRoute("POST",   "/api/v1/commerce/orders",          "commerce:commerce_orders", "create");
registerRoute("GET",    "/api/v1/commerce/orders",          "commerce:commerce_orders", "read");
registerRoute("GET",    "/api/v1/commerce/orders/:id",      "commerce:commerce_orders", "read",   "id");
registerRoute("PATCH",  "/api/v1/commerce/orders/:id/status", "commerce:commerce_orders", "update", "id");
registerRoute("POST",   "/api/v1/commerce/orders/:id/cancel", "commerce:commerce_orders", "update", "id");
registerRoute("GET",    "/api/v1/commerce/orders/:id/status-history", "commerce:commerce_orders", "read", "id");
registerRoute("GET",    "/api/v1/inventory",                "commerce:inventory",  "read");
registerRoute("GET",    "/api/v1/inventory/:productId",     "commerce:inventory",  "read");
registerRoute("PATCH",  "/api/v1/inventory/:productId",     "commerce:inventory",  "update");
registerRoute("GET",    "/api/v1/products/:id/reviews",     "commerce:product_reviews", "read");
registerRoute("POST",   "/api/v1/products/:id/reviews",     "commerce:product_reviews", "create");
registerRoute("PATCH",  "/api/v1/products/:id/reviews/:reviewId", "commerce:product_reviews", "update");
registerRoute("GET",    "/api/v1/coupons",                  "commerce:coupons",    "read");
registerRoute("POST",   "/api/v1/coupons",                  "commerce:coupons",    "create");
registerRoute("PATCH",  "/api/v1/coupons/:id",              "commerce:coupons",    "update",  "id");
registerRoute("DELETE", "/api/v1/coupons/:id",              "commerce:coupons",    "delete",  "id");
registerRoute("POST",   "/api/v1/coupons/validate",         "commerce:coupons",    "read");

// -- Support Domain --
registerRoute("POST",   "/api/v1/tickets",                  "support:tickets",     "create");
registerRoute("GET",    "/api/v1/tickets",                  "support:tickets",     "read");
registerRoute("GET",    "/api/v1/tickets/:id",              "support:tickets",     "read",    "id");
registerRoute("PATCH",  "/api/v1/tickets/:id/status",       "support:ticket_status", "update");
registerRoute("PATCH",  "/api/v1/tickets/:id/assign",       "support:ticket_assignment", "update");
registerRoute("PATCH",  "/api/v1/tickets/:id/priority",     "support:ticket_status", "update");
registerRoute("DELETE", "/api/v1/tickets/:id",              "support:tickets",     "delete",  "id");
registerRoute("POST",   "/api/v1/tickets/:id/messages",     "support:ticket_messages", "create");
registerRoute("GET",    "/api/v1/tickets/:id/messages",     "support:ticket_messages", "read");
registerRoute("PATCH",  "/api/v1/tickets/:id/messages/:messageId", "support:ticket_messages", "update");
registerRoute("DELETE", "/api/v1/tickets/:id/messages/:messageId", "support:ticket_messages", "delete");
registerRoute("POST",   "/api/v1/tickets/:id/rate",         "support:tickets",     "create",  "id");
registerRoute("POST",   "/api/v1/tickets/:id/link-article", "support:tickets",     "update",  "id");
registerRoute("GET",    "/api/v1/knowledge/articles",       "support:knowledge_articles", "read");
registerRoute("POST",   "/api/v1/knowledge/articles",       "support:knowledge_articles", "create");
registerRoute("GET",    "/api/v1/knowledge/articles/:id",   "support:knowledge_articles", "read", "id");
registerRoute("PATCH",  "/api/v1/knowledge/articles/:id",   "support:knowledge_articles", "update", "id");
registerRoute("DELETE", "/api/v1/knowledge/articles/:id",   "support:knowledge_articles", "delete", "id");
registerRoute("POST",   "/api/v1/knowledge/articles/:id/publish",   "support:knowledge_article_publish", "update");
registerRoute("POST",   "/api/v1/knowledge/articles/:id/unpublish", "support:knowledge_article_publish", "update");
registerRoute("POST",   "/api/v1/knowledge/articles/:id/feedback",  "support:knowledge_articles", "read");
registerRoute("GET",    "/api/v1/support/reports",          "support:ticket_reports", "read");

// -- Content Domain --
registerRoute("POST",   "/api/v1/pages",                    "content:pages",       "create");
registerRoute("GET",    "/api/v1/pages",                    "content:pages",       "read");
registerRoute("GET",    "/api/v1/pages/:id",                "content:pages",       "read",    "id");
registerRoute("PATCH",  "/api/v1/pages/:id",                "content:pages",       "update",  "id");
registerRoute("DELETE", "/api/v1/pages/:id",                "content:pages",       "delete",  "id");
registerRoute("POST",   "/api/v1/pages/:id/publish",        "content:page_publish", "create");
registerRoute("POST",   "/api/v1/pages/:id/unpublish",      "content:page_publish", "update");
registerRoute("POST",   "/api/v1/pages/:id/schedule",       "content:page_schedule", "create");
registerRoute("GET",    "/api/v1/pages/:id/versions",       "content:page_versions", "read");
registerRoute("GET",    "/api/v1/pages/:id/versions/:version", "content:page_versions", "read");
registerRoute("POST",   "/api/v1/pages/:id/versions/:version/restore", "content:page_versions", "restore");
registerRoute("POST",   "/api/v1/media",                    "content:media",       "create");
registerRoute("GET",    "/api/v1/media",                    "content:media",       "read");
registerRoute("GET",    "/api/v1/media/:id",                "content:media",       "read",    "id");
registerRoute("DELETE", "/api/v1/media/:id",                "content:media",       "delete",  "id");
registerRoute("POST",   "/api/v1/blog",                     "content:blog_posts",  "create");
registerRoute("GET",    "/api/v1/blog",                     "content:blog_posts",  "read");
registerRoute("GET",    "/api/v1/blog/:id",                 "content:blog_posts",  "read",    "id");
registerRoute("PATCH",  "/api/v1/blog/:id",                 "content:blog_posts",  "update",  "id");
registerRoute("DELETE", "/api/v1/blog/:id",                 "content:blog_posts",  "delete",  "id");
registerRoute("POST",   "/api/v1/blog/:id/publish",         "content:blog_publish", "create");
registerRoute("POST",   "/api/v1/blog/categories",          "content:blog_categories", "create");
registerRoute("GET",    "/api/v1/blog/categories",          "content:blog_categories", "read");

// -- Notification Domain --
registerRoute("GET",    "/api/v1/notifications/templates",  "notification:notification_templates", "read");
registerRoute("POST",   "/api/v1/notifications/templates",  "notification:notification_templates", "create");
registerRoute("PATCH",  "/api/v1/notifications/templates/:id", "notification:notification_templates", "update");
registerRoute("DELETE", "/api/v1/notifications/templates/:id", "notification:notification_templates", "delete");
registerRoute("GET",    "/api/v1/notifications/log",        "notification:notification_logs", "read");
registerRoute("POST",   "/api/v1/notifications/send",       "notification:notification_bulk", "create");
registerRoute("GET",    "/api/v1/users/me/notifications/preferences", "notification:notification_preferences", "read");
registerRoute("PATCH",  "/api/v1/users/me/notifications/preferences", "notification:notification_preferences", "update");

// -- Analytics Domain --
registerRoute("GET",    "/api/v1/analytics/dashboards",     "analytics:analytics_dashboards", "read");
registerRoute("POST",   "/api/v1/analytics/dashboards",     "analytics:analytics_dashboards", "create");
registerRoute("PATCH",  "/api/v1/analytics/dashboards/:id", "analytics:analytics_dashboards", "update");
registerRoute("DELETE", "/api/v1/analytics/dashboards/:id", "analytics:analytics_dashboards", "delete");
registerRoute("GET",    "/api/v1/analytics/reports",        "analytics:analytics_reports", "read");
registerRoute("POST",   "/api/v1/analytics/reports",        "analytics:analytics_reports", "create");
registerRoute("GET",    "/api/v1/analytics/reports/:id/download", "analytics:analytics_report_export", "read");
registerRoute("GET",    "/api/v1/analytics/kpis",           "analytics:analytics_kpis", "read");
registerRoute("POST",   "/api/v1/analytics/kpis",           "analytics:analytics_kpis", "create");
registerRoute("GET",    "/api/v1/analytics/metrics",        "analytics:analytics_metrics", "read");

// -- AI Domain --
registerRoute("GET",    "/api/v1/ai/agents",                "ai:ai_agents",        "read");
registerRoute("POST",   "/api/v1/ai/agents",                "ai:ai_agents",        "create");
registerRoute("PATCH",  "/api/v1/ai/agents/:id",            "ai:ai_agents",        "update",  "id");
registerRoute("DELETE", "/api/v1/ai/agents/:id",            "ai:ai_agents",        "delete",  "id");
registerRoute("POST",   "/api/v1/ai/agents/:id/invoke",     "ai:ai_agent_invoke",  "execute");
registerRoute("POST",   "/api/v1/ai/chat",                  "ai:ai_chat",          "send");
registerRoute("GET",    "/api/v1/ai/knowledge",             "ai:ai_knowledge",     "read");
registerRoute("POST",   "/api/v1/ai/knowledge",             "ai:ai_knowledge",     "create");
registerRoute("GET",    "/api/v1/ai/prompts",               "ai:ai_prompts",       "read");
registerRoute("POST",   "/api/v1/ai/prompts",               "ai:ai_prompts",       "create");
registerRoute("PATCH",  "/api/v1/ai/prompts/:id",           "ai:ai_prompts",       "update",  "id");
registerRoute("DELETE", "/api/v1/ai/prompts/:id",           "ai:ai_prompts",       "delete",  "id");
registerRoute("POST",   "/api/v1/ai/prompts/:id/activate",  "ai:ai_prompt_activate", "update");
registerRoute("GET",    "/api/v1/ai/interactions",          "ai:ai_interactions",  "read");
registerRoute("GET",    "/api/v1/ai/interactions/stats",    "ai:ai_interaction_stats", "read");
